          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center justify-between">
                  ...
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      <div className="relative flex">
                        <PopoverButton className="group relative flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out hover:text-gray-800 data-open:text-indigo-600">
                          {category.name}
                          <span
                            aria-hidden="true"
              ...
              <div className="flex flex-1 items-center justify-end">
                <a
                  href="#"
                  className="hidden  hover:text-gray-800 lg:flex lg:items-center"
                >
                  <img
                    alt=""
                    src="https://tailwindcss.com/plus-assets/img/flags/flag-canada.svg"
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  >
                    <ShoppingBagIcon
                      aria-hidden="true"
                      className="size-6 shrink-0 text-gray-400 dark:text-white group-hover:text-gray-500 dark:group-hover:text-gray-300"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700 dark:text-white group-hover:text-gray-800">
                      <Count />
                    </span>
