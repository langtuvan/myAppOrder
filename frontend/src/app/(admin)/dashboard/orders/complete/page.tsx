...
import { useOrderList, CompleteStatusOptions as statusOptions } from "@/hooks/useOrders";
...
export default function ProductPage() {
  const {
    ...
    setCurrentStatus,
    dataFiltered,
  } = useOrderList({ statusOptions, defaultStatus: OrderStatus.DELIVERED });

  const searchQuery = `status=${currentStatus}&date=${selectedDate}`;

  const onSelect = (id: string) => {
    router.push(paths.dashboard.orders.complete(id, searchQuery));
  };
  return (
    <>
